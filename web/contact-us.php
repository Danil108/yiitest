        ...
        <div class="container">
            ...
            <form action="#" class="form">
                <div class="container form-white">
                    ...
                    <h3 class="text-center text-Bubblegum">Відправте ваше запитання</h3>
                <div class="row justify-content-center">
                <div class="col-md-6">
                    <input type="name" required class="form-control" id="name" placeholder="Ім'я" >
                    <input type="email" required class="form-control" id="email"  placeholder="Номер телефону">
                    <input type="number" required class="form-control" id="number" placeholder="Електронна пошта">
                    <textarea name="comment" required class="form-control" id="message" placeholder="Повідомлення" cols="30" rows="5"></textarea>

                    <div class="col-md-12 d-flex justify-content-center">
                        <button type="submit" class="btn btn-success w-50">Відправити</button>
                    </div>
                    </div>
                </div>
            </div>
